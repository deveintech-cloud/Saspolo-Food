      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-orange-500/20 bg-orange-500/5 mx-auto lg:mx-0">
            ...
            <h2 className="text-4xl md:text-6xl font-bold font-jakarta tracking-tight leading-[1.1] text-white">
              {t('roots_title_pre')}{' '}
            ...
            <div className="grid sm:grid-cols-2 gap-8 pt-6">
              <div className="space-y-3">
                <div className="flex items-center justify-center lg:justify-start gap-3 text-white font-bold text-sm uppercase tracking-widest">
